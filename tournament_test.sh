...
echo -e "${YELLOW}Tournament Round Advancement Demo${NC}"
...
tournament_response=$(curl -s -X POST -H "Content-Type: application/json" -H "Authorization: Bearer $token" -d '{"name":"Bracket Advanced Demo","max_participants":8}' "$BASE_URL/tournaments")
